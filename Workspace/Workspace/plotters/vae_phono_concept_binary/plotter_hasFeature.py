...
alpha = 0.4
plt.scatter(embeddings_transformed[bins["no "+label],0],embeddings_transformed[bins["no "+label],1],color=cmap[0],alpha=alpha,label="no "+label)
plt.scatter(embeddings_transformed[bins[label],0],embeddings_transformed[bins[label],1],color=cmap[1],alpha=alpha,label=label)
