...
geo_words_scaled = normalize(geo_words)

"""
SCALING PHONO DATA
"""
print("SCALING PHONO DATA")
word_matrices_scaled = normalize(word_matrices)
...
vae.fit(x=[word_matrices_scaled],
         y=[word_matrices_scaled],
      batch_size=batch_size, nb_epoch=nb_epoch)
encoder = Model([input_phono], z_mean)
embeddings = encoder.predict(x=[word_matrices_scaled],batch_size=batch_size)
...
pickle.dump(word_matrices_scaled,codecs.open("embeddings/vae_phono/word_matrices_scaled.pkl","wb"))
