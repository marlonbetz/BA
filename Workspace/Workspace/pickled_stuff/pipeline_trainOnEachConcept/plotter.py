...
pairwise_precision = pickle.load(codecs.open("pairwise_precision.pkl","rb"))
pairwise_recall = pickle.load(codecs.open("pairwise_recall.pkl","rb"))
pairwise_f1 = pickle.load(codecs.open("pairwise_f1.pkl","rb"))
...
pairwise_precision_random = pickle.load(codecs.open("pairwise_precision_random.pkl","rb"))
pairwise_recall_random = pickle.load(codecs.open("pairwise_recall_random.pkl","rb"))
pairwise_f1_random = pickle.load(codecs.open("pairwise_f1_random.pkl","rb"))
...
def toLatexTable():
    return DataFrame(np.array([#adjusted_rand_scores.mean(),
                             ...
                             pairwise_precision_random.mean(),
                             #pairwise_recall.mean(),
                             pairwise_recall_random.mean(),
                             #pairwise_f1.mean(),
                             pairwise_f1_random.mean(),
                             
                             ]),#columns=["ARI","ARI","AMI","AMI","H","H","C","C","V","V"]
                     index = ["ARI","AMI","H","C","V","P","R","F1"]
                     ).transpose().to_latex()
