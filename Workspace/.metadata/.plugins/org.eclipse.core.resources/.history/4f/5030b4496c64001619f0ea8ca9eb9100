...
SCALE GEO INFO
"""
print("SCALE GEO INFO")
from sklearn.preprocessing import MinMaxScaler
minmax = MinMaxScaler()
geo_info_tr = minmax.fit_transform(geo_info)
"""
...
X = np.append(X,geo_info_tr,axis=1)
...
pickle.dump(languages,codecs.open("embeddings/vae_phono_concept_geo_binary_asjp/languages.pkl","wb"))
pickle.dump(allWords,codecs.open("embeddings/vae_phono_concept_geo_binary_asjp/allWords.pkl","wb"))
pickle.dump(concepts,codecs.open("embeddings/vae_phono_concept_geo_binary_asjp/concepts.pkl","wb"))
pickle.dump(geo_info,codecs.open("embeddings/vae_phono_concept_geo_binary_asjp/geo_info.pkl","wb"))

#actual embeddings
pickle.dump(embeddings,codecs.open("embeddings/vae_phono_concept_geo_binary_asjp/embeddings.pkl","wb"))
