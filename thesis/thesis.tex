...
Hence, the architecture of the models described here can be divided into three different components:
\begin{enumerate}
...
\caption{The performance of VAE-C compared to LexStat. VAE-C performs only mediocre, but far better than random indexing.}
\end{table}
