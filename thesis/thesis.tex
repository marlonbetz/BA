...
\begin{enumerate}
\item to combine methods from both Computational Historical Linguistics, Bayesian Hierarchical models and the emerging field of Deep Learning
