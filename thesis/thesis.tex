...
If we define the Kullback-Leibler divergence from the true posterior to its approximation as 
...
E_{\epsilon \sim \mathcal(0,1)}[\log P(X|z= \mu + \sigma \odot \epsilon) - D_{KL}(Q(z|X)||P(z))] 
\end{equation}
